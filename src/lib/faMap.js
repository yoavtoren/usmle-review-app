...
export const FA_CHAPTERS = [
  { file: "chapters/01_Biochem.md",                name: "Biochem",
  ...
  { file: "chapters/02_Immunology.md",             name: "Immunology",
    kw: ["immun", "antibody", "complement", "hypersensitiv", "cytokine", "hla", "mhc", "t cell", "b cell", "vaccine"] },
  { file: "chapters/03_Micro.md",                  name: "Micro",
  ...
  { file: "chapters/06_Public_Health.md",          name: "Public Health",
  ...
  { file: "chapters/07_Cardio.md",                 name: "Cardiovascular",
  ...
  { file: "chapters/08_Endocrine.md",              name: "Endocrine",
  ...
  { file: "chapters/09_GI.md",                     name: "Gastrointestinal",
  ...
  { file: "chapters/10_Heme_Onc.md",               name: "Heme / Onc",
  ...
  { file: "chapters/11_MSK_Skin_Connective.md",    name: "MSK, Skin & Connective",
  ...
  { file: "chapters/12_Neuro_Special_Senses.md",   name: "Neuro & Special Senses",
...
export function chaptersFromText(text) {
  ...
  for (const ch of FA_CHAPTERS) {
    if (ch.kw.some(k => (k.startsWith("\\b") ? new RegExp(k).test(s) : s.includes(k)))) {
      hits.push({ file: ch.file, name: ch.name });
    }
  }
  return hits;
}
...
export function resolveFAChapters(qFull, inferred) {
  ...
  const seen = new Set();
  const push = (file) => {
    if (file && byFile[file] && !seen.has(file)) { seen.add(file); out.push({ file, name: byFile[file].name }); }
  };
